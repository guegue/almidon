...
var buttonName2 = new Array();/*
  ...
  buttonName2[16]  = "help";
  */buttonName2[0]  = "forecolor";
	buttonName2[1]  = "seperator";
        buttonName2[2]  = "undo";
	buttonName2[3]  = "redo";
	buttonName2[4]  = "seperator";
	buttonName2[5] = "unorderedlist";
	buttonName2[6] = "orderedlist";
	buttonName2[7] = "outdent";
	buttonName2[8] = "indent";
  buttonName2[9]  = "seperator";
...
function generate_wysiwyg(textareaID) {
  ...
  toolbar2 += '<td>&nbsp;</td></tr></table>';  
	...
	var iframe = '<table cellpadding="0" cellspacing="0" border="0" style="width:' + wysiwygWidth + 'px; height:' + wysiwygHeight + 'px;border: 1px inset #CCCCCC; background-color:#ffffff;" class="iframe"><tr><td valign="top">\n'
  + '<iframe class="textrich" frameborder="0" id="wysiwyg' + n + '"></iframe>\n'
  + '</td></tr></table>\n';
