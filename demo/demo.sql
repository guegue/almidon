...
-- **  Las líneas descomentadas contienen instrucciones por     ** 
-- **  defecto que son necesarias que se van a ejecutar al      **
-- **  momento de invocar y ejecutar este script.               ** 				                        

-- *Importar y ejecutar script sql externo                       *
 	                       
-- ** Método 1                                                   *
-- ***************************************************************
-- *Importar Script Dentro Consola  interactiva.                 *
-- ***************************************************************
...
-- ** Método 2                                                   *
-- ***************************************************************
-- *Importar y ejecutar Script fuera de la Consola Inter.       **
-- ***************************************************************
-- **   psql -f ./create.sql                                    **

-- ** Método 3 
-- ** Importar y ejecutar script .sql externo  dentro de código **
-- ** de otro script .sql

-- ** Recomendado					**
-- ** Si se usa la consola postgres y se ejecuta este script    **
-- ** con ayuda de ésta.					**
-- ** \i ./create.sql

-- ***************************************************************
-- Métodos de conexión a Base de Datos almidondemo              **
-- ***************************************************************

-- ***************************************************************
-- ** Método 1                                                  **
-- ** Consola Interactiva                                       **
-- ** Una vez dentro de la consola interactiva  de Postgres     **
-- ** Conexión a la Base de Datos almidondemo                   **
--   psql \connect almidondemo                                  **

-- ***************************************************************
-- ** Método 2                                                  **
-- ** Fuera de la consola interactiva  de Postgres              **
-- ** Conexión a la Base de Datos almidondemo                   **
-- **  psql -d almidondemo                                      **

-- ***************************************************************
-- ** Método 3                                                  **
-- ** Dentro del contenido de este script sql                   **

-- ** Sentencias SQL                                            **
-- ** Usa la Base de Datos almidondemo sólo si existe.          **
-- ** USE almidondemo IF EXISTS almidondemo;                    **
...
-- ***************************************************************
-- * Importar Script Externo Dentro Consola  Interactiva         *
-- ***************************************************************

-- ** Método 1                                                   * 
-- ***************************************************************
-- * Ingreso a la consola interactiva  de Postgres               *
-- ** psql \i ../../core/sql/alm.tables.sql                     **

-- ** Método 2                                                   *
-- ***************************************************************
-- * Importar y ejecutar Script fuera de la Consola Inter.       *
-- ***************************************************************
-- ** psql -f ../../core/sql/alm.tables.sql                     **

-- ** Método 3                                                   *
-- ***************************************************************
-- * Importar Script Externo Dentro del contenido de otro script *
-- ** Si se usa la consola postgres y se ejecuta este script    **
-- ** con ayuda de ésta.					**
