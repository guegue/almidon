...
?>
<?
$conn = pg_pconnect("port=5432 dbname=almidondemo user=almidondemo password=secreto1");
if ($conn) echo "Conexion a base de datos con usuario almidondemo: OK <br/>";
$conn2 = pg_pconnect("port=5432 dbname=almidondemo user=almidondemowww password=secreto2");
