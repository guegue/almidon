...
$PHPTHUMB_CONFIG['cache_directory'] = $PHPTHUMB_CONFIG['document_root'] . '/../cache/imgs/';
...
$PHPTHUMB_CONFIG['cache_source_directory'] = $PHPTHUMB_CONFIG['document_root'] . '/../cache/imgs/source/';  // set the cache directory for unprocessed source images
...
if (phpthumb_functions::version_compare_replacement(phpversion(), '4.3.2', '>=') && !defined('memory_get_usage') && !@ini_get('memory_limit')) {
	...
	// calculate default max_source_pixels as 1/4 (25%) of memory limit configuration
	$PHPTHUMB_CONFIG['max_source_pixels'] = round(max(intval(ini_get('memory_limit')), intval(get_cfg_var('memory_limit'))) * 1048576 / 4);
	//$PHPTHUMB_CONFIG['max_source_pixels'] = 0;       // no memory limit
