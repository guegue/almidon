...
CREATE TABLE alm_column (idalm_column varchar (50), idalm_table varchar (48) REFERENCES alm_table, type varchar (16), size int, pk bool, fk varchar(48), alm_column varchar(250), extra text, rank int, idalm_role varchar(8) REFERENCES alm_role, label_bool varchar(100), display varchar(200), help text, search bool, list_values varchar(500), PRIMARY KEY (idalm_column, idalm_table));
