<?php
	...
	class ajaxServer extends HTML_AJAX_Server {
		...
		function initLiveFillCombo() {
			include 'livefillcombo.class.php';
			$this->registerClass(new livefillcombo());
		}
	}

	// create an instance of our test server
	$server = new ajaxServer();
